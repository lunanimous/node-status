...
<head>
    ...
    <title>Nimiq NodeStatus - Lunanimous</title>
...
<body class="font-sans bg-gray-100">
    <div class="container mx-auto max-w-2xl p-4">
        <header class="flex items-center mt-2">
            ...
            <span class="text-xl text-gray-600 ml-6">Nimiq Node Status</span>
        </header>
        ...
        <footer class="flex justify-between mt-12 text-sm text-gray-500">
            <div>Made by <a class="underline" href="https://lunanimous.com" target="_blank">Lunanimous.</a></div>
